...
while True:
    ...
    # print([[source.id for source in citation.sources] for citation in response.message.citations])
    print([
        source.id 
    ...
    # references contain chunk ids, get page numbers from chunk ids
    page_nums = []
    for reference in references:
        chunk = smart_chunks[int(reference)]
        if chunk in page_numbers:
            page_nums.append(page_numbers[chunk])
